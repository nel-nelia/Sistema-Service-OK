        ...
        <div class="full-reset container-menu-movile custom-scroll-containers">
            ...
            <div class="full-reset nav-lateral-list-menu">
                <ul class="list-unstyled">
                    ...
                    <li><a href="vistas/principal.php"><i class="zmdi zmdi-home zmdi-hc-fw"></i>&nbsp;&nbsp; CONSULTAR ESTADO ESTABLECIMIENTO</a></li>
                ...
                <li class="mobile-menu-button visible-xs" style="float: left !important;">
                 ...
                 <div class="col-lg-12">
                        <div class="card">
                            ...
                            <h6 class="m-0 font-weight-bold text-primary">AGREGAR TIPO DE ACTIVIDADES</h6>
                            </div>
                            <div class="card-body">                         
                                ...
                                <form action="procesos/agregartipoactividad.php" method="POST">  
