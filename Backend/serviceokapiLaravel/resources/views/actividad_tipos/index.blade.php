...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">Actividad Tipos</h4>
            </div>
        ...
        @if(count($actividadTipos) == 0)
            <div class="panel-body text-center">
                <h4>No Actividad Tipos Available.</h4>
            </div>
        @else
            ...
            <div class="table-responsive">
                ...
                <table class="table table-striped ">
                    ...
                    @foreach($actividadTipos as $actividadTipo)
                        <tr>
                            <td>{{ $actividadTipo->FlagActivo }}</td>
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('actividad_tipos.actividad_tipo.show', $actividadTipo->ActividadTipoID ) }}" class="btn btn-info" title="Show Actividad Tipo">
