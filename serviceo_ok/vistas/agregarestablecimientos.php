...
<section id="main-content">
	...
	<div class="form-w3layouts">
        ...
        <section class="panel">
            ...
            <form action="../controladores/guardarestnuevo.php" method="POST">  
                     
                <div class="form-group">            
                        <div class="form-group">
                            <label class="col-sm-3 control-label col-lg-3">Establecimiento</label>
                            <div class="col-lg-6">
                                <div class="input-group m-bot15">
                                    <span class="input-group-addon btn-white"><i class="fa fa-user"></i></span>
                                    <input type="text" class="form-control" name="establecimiento" value="<?php echo $nombreest; ?>" >
                                </div>
                            </div>
                        </div><br><br><br>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group m-bot15">
                                    ...
                                    <input type="text" class="form-control" name="Telefono" value="<?php echo $celular; ?>" placeholder="Username">
                                </div>
                            </div>
                        </div><br><br>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group m-bot15">
                                    <span class="input-group-addon btn-white"><i class="fa fa-phone"></i></span>
                                    <input type="text" class="form-control" name="latitud" placeholder="Username">
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group m-bot15">
                                    <span class="input-group-addon btn-white"><i class="fa fa-phone"></i></span>
                                    <input type="text" class="form-control" name="longitud" placeholder="Username">
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group m-bot15">
                                    <span class="input-group-addon btn-white"><i class="fa fa-phone"></i></span>
                                    <input type="text" class="form-control" name="Distrito" placeholder="Username">
                                </div>
