        ...
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label col-lg-3">Teléfono</label>
                        <div class="col-lg-6">
                            <div class="input-group m-bot15">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label col-lg-3">Whatsapp</label>
                        <div class="col-lg-6">
                            <div class="input-group m-bot15">
                                <span class="input-group-addon btn-white"><i class="fa fa-whatsapp"></i></span>
                                <input type="text" class="form-control" placeholder="Username">
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <div class="input-group m-bot15">
                                <span class="input-group-addon btn-white"><i class="fa fa-motorcycle"></i></span>
                                <input type="text" class="form-control" placeholder="Username">
                            </div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label col-lg-3">Permiso</label>
                        <div class="col-lg-6">
                            <div class="input-group m-bot15">
                                <span class="input-group-addon btn-white"><i class="fa fa-hand-peace-o"></i></span>
                                <input type="text" class="form-control" placeholder="Username">
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <div class="input-group m-bot15">
                                <span class="input-group-addon btn-white"><i class="fa fa-newspaper-o"></i></span>
                                <input type="text" class="form-control" placeholder="Username">
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <div class="input-group m-bot15">
                                <span class="input-group-addon btn-white"><i class="fa fa-map-signs"></i></span>
                                <input type="text" class="form-control" placeholder="Username">
                            </div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label col-lg-3">Longitud</label>
                        <div class="col-lg-6">
                            <div class="input-group m-bot15">
                                <span class="input-group-addon btn-white"><i class="fa fa-map-signs"></i></span>
                                <input type="text" class="form-control" placeholder="Username">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label col-lg-3">Representante</label>
                        <div class="col-lg-6">
                        <select class="form-control m-bot15">
                                <option>Option 1</option>
                                <option>Option 2</option>
